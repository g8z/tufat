...
<html>
<head><title>##Events Sources##</title>
...
{if $mydata.xtag != '' && $mydata.ID !=''}
        ...
        <font class="title">{$mydata.taghdr01} ##Events Sources##</font>
        <br />
        <br /><br />
        ...
        {if !isset( $smarty.session.read_only) || $smarty.session.my_rec == $mydata.ID}
                ...
                <font class="normal">
                <a href='showevens.php?add=1&amp;ID={$mydata.ID}&amp;xtag={$mydata.xtag}'>##Add Sources##</a> |
                        ...
                        <tr>
                                <td>
                                        {if !isset( $smarty.session.read_only ) || $smarty.session.my_rec == $mydata.ID}
                                                ...
                                                <input type='button' onclick='if (confirm(\"##Are you sure?##\"))   location.href="showevens.php?ID={$mydata.ID}&amp;del=1&amp;xtag={$mydata.xtag}&amp;mid={$disp->hid}"' value='##Del##' />


                                        {/if}

                                        <a href='#'  onclick="window.open('editsour.php?sid={$disp->hid}','hh','width=400,height=380,resize=1,scrollbars=1')" >
                                        {$disp->titl}
                                        </a>
                                </td>
                        </tr>
